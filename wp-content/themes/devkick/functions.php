...
function kdev_scripts() {
    ...
    wp_enqueue_style( 'kdev_css', get_template_directory_uri(). '/assests/css/main.css', array('bootstrap_css'),
    KDEV_VERSION, 'all' );
    ...
    wp_enqueue_script( 'kdev_script', get_template_directory_uri(). '/assests/js/main.js', array('jquery_cdn', 'bootstrap_js', 'bootstrap_popper'),KDEV_VERSION, true );
